...
function RenderBookList(bookData) {
  ...
  const containerIncomplete = document.getElementById("Story");
  const containerComplete = document.getElementById("completeBookshelfList");

  containerIncomplete.innerHTML = "<div class='chat'> </div>";
  containerComplete.innerHTML = "<div class='chat'> </div>";
  for (let book of bookData) {
    ...
    bookItem.classList.add("chat", "select_item");
    bookItem.innerHTML = "<img src='https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg?t=st=1702268432~exp=1702269032~hmac=3a18d37d962828ca2dd3da981321878362f42803cb925dedb8664a49ddc74b6c' alt='logo' >";
    bookItem.innerHTML += "<li><a name = " + id + ">" + title + "</a></li>";
    bookItem.innerHTML += "<p>" + author + "</p>";
    bookItem.innerHTML += "<p>" + year + "</p>";

    //container action item
    let containerActionItem = document.createElement("div");
    containerActionItem.classList.add("hidden");
